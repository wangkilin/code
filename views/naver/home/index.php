<?php View::output('global/header.tpl.htm'); ?>
			...
			<div class="row aw-content-wrap">
				<div class="col-sm-12 col-md-9 aw-main-content ">
					...
					<div class="aw-mod aw-dynamic-topic clearfix">
						...
						<div class="aw-mod-body clearfix" id="main_contents" style="width:800px;"></div>
				...
				<div class="col-sm-12 col-md-3 aw-side-bar hidden-xs hidden-sm">
					<?php View::output('block/sidebar_announce.tpl.htm'); ?>
					
					<?php View::output('block/sidebar_menu.tpl.htm'); ?>	
					...
					<!-- 可能感兴趣的人/或话题 -->
					<?php View::output('block/sidebar_recommend_users_topics.tpl.htm'); ?>
				</div>
				<!-- end 侧边栏 -->
			</div>
		</div>
...
<?php View::output('global/footer.tpl.htm'); ?>