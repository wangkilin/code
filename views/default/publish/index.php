					...
					<form action="publish/ajax/<?php if ($this->question_info['question_id']) { ?>modify<?php } else { ?>publish<?php } ?>_question/" method="post" id="question_form" onsubmit="return false;">
						...
						<div class="icb-mod icb-mod-publish">
							<div class="mod-body">
								<h3><?php _e('问题标题'); ?>:</h3>
								<!-- 问题标题 -->
								<div class="icb-publish-title<?php if (!$this->tagsDropdown) { ?> active<?php } ?>">
									<div>
									...
									<div class="dropdown">
										<div class="dropdown-toggle" data-toggle="dropdown">
											<span id="icb-selected-tag-show" class="icb-hide-txt"><?php _e('选择分类'); ?></span>
								...
								<div class="icb-mod icb-editor-box">
									<div class="mod-head">
										<div class="wmd-panel">
								            <textarea class="article-content form-control autosize editor" id="article-content" rows="15" name="question_detail"><?php echo $this->question_info['question_detail']; ?></textarea>
								        </div>
									</div>
									<div class="mod-body">
