...
<body>
    ...
    <![endif]-->
    <div class="icb-reader">
        <div class="container">
            <div class="row">
                <div class="col-md-3 col-sm-3 pull-left icb-reader-side" id="left_panel" >
                    <div class="header">
                    ...
                    <div class="filter">
                        <div class="dropdown-list-wrap" <?php if (sizeof($this->feature_list) == 0) { ?> class="collapse"<?php } ?>>
                            <span>全部内容</span>
                        ...
                        <select id="feature_selecter"<?php if (sizeof($this->feature_list) == 0) { ?> class="collapse"<?php } ?>>
                    ...
                    <div class="nav-container icb-mod">
                        <ul id="data_lister">
                ...
                <div class="col-md-9 col-sm-9 pull-right collapse icb-reader-content"  id="right_panel" >
                    <div class="header">
                        <a href="#" class="top-actions" id="top_actions"><?php _e('查看原问题'); ?></a>
                    ...
                    <div class="question icb-mod">
                        ...
                        <div class="mod-footer">
                            <div class="icb-answer">
                                <div class="icb-answer-info">
                                    ...
                                    <div class="icb-answer-body">
                                        <div class="answer-vote-info collapse" id="answer_vote_info">
                                            ...
                                            <ul class="vote-info-users-list collapse" id="vote_info_users_list_more">
