...
<div class="icb-item<?php if ($val['type'] == 'questions' OR $val['type'] == 'articles') { ?> active<?php } ?>">
	<?php if ($val['type'] == 'topics') { ?>
	<a href="<?php echo $val['url']; ?>" class="icb-topic-img" data-id="<?php echo $val['search_id']; ?>"><img src="<?php echo $val['detail']['topic_pic']; ?>" alt="" /></a>
	<?php } else if ($val['type'] == 'users') { ?>
	<a href="<?php echo $val['url']; ?>" class="icb-user-img" data-id="<?php echo $val['search_id']; ?>"><img src="<?php echo $val['detail']['avatar_file']; ?>" alt="" /></a>
	<?php } ?>
	<?php if ($this->user_id) { ?>
