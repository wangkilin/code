...
<div class="icb-content-wrap">
    <div class="mod">
        ...
        <form action="admin/ajax/weixin/send_msg/" id="msg_form" method="post" onsubmit="return false" enctype="multipart/form-data">
                ...
                <tr>
                    <td>
                        <div class="form-group">
                            ...
                            <div class="col-sm-5 col-xs-8">
                                <textarea class="form-control textarea" name="main_msg_content" rows="10"></textarea>
                            </div>
                        </div>
                    </td>
                </tr>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <span class="mod-file">
                                    ...
                                    <input type="file" name="main_msg_img" exts="bmp|png|jpg|jpeg|gif" class="mod-input-file" />
                                </span>
                                <p class="filetext"></p>
                                <span class="help-block"><?php _e('图片支持 bmp/png/jpeg/jpg/gif 格式，最大为 2M'); ?></span>
                            </div>
                        </div>
                    </td>
                </tr>
                    ...
                    <td>
                        <div class="form-group">
                            ...
                            <div class="col-sm-5 col-xs-8 mod-question">
                                ...
                                <input class="question_ids collapse" name="question_ids" value="" type="hidden" />
                            </div>
                        </div>
                    </td>
                </tr>
