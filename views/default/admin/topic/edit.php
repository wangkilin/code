					...
					<td>
						<div class="form-group">
							...
							<div class="col-sm-9 col-xs-8">
								<a id="topic_pic_uploader"><img src="<?php echo getModulePicUrlBySize('topic', 'mid', $this->topic_info['topic_pic']); ?>" alt="" id="topic_pic" class="img-polaroid" name="topic_pic" /></a>
							</div>
						</div>
					</td>
				</tr>
