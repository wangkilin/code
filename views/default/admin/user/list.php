...
<div class="icb-content-wrap" id="user_list">
    <div class="mod">
        <div class="mod-head">
            <h3>
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="user/<?php if ($val['url_token']) echo $val['url_token']; else echo urlencode($val['user_name']); ?>" target="_blank"><?php echo $val['user_name']; ?></a> <?php if ($val['forbidden']) { ?><span class="text-color-999">[ <?php _e('封禁'); ?> ]</span><?php } else if (!$val['valid_email']) { ?><span class="text-color-999">[ <?php _e('邮件未验证'); ?> ]</span><?php } ?></td>
