						...
						<div class="mod-body js-scrollup">
							<ul class="col-sm-12">
								...
								<li class="pull-left margin-5 padding10">
                                    <img style="max-width:30px; max-height:18px; width:auto;display:inline-block;" src="//www.icodebang.cn/uploads/nav_menu/<?php echo $this->categoryList[$_categoryId]['icon'] ;?>" alt="<?php echo $this->categoryList[$_categoryId]['title'];?>"> <a href="article/index/category-<?php echo $this->categoryList[$_categoryId]['url_token']; ?>"><?php echo $this->categoryList[$_categoryId]['title']; ?></a>
                                </li>
                                <?php
                                    if ($_tmpI++ % 25 == 0) {
