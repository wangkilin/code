<div class="icb-item" id="answer_list_<?php echo $this->comment_info['id']; ?>">
	<div class="mod-head">
		<a class="icb-user-img icb-border-radius-5" href="user/<?php echo $this->comment_info['user_info']['url_token']; ?>">
			<img src="<?php echo get_avatar_url($this->comment_info['uid'], 'mid'); ?>" alt="<?php echo $this->comment_info['user_info']['user_name']; ?>" />
		</a>
		<p>
			<a href="user/<?php echo $this->comment_info['user_info']['url_token']; ?>"><?php echo $this->comment_info['user_info']['user_name']; ?></a><?php if ($this->comment_info['at_user_info']) { ?> <?php _e('回复'); ?> <a href="user/<?php echo $this->comment_info['at_user_info']['url_token']; ?>"><?php echo $this->comment_info['at_user_info']['user_name']; ?></a><?php } ?>
		</p>
	</div>
	<div class="mod-body">
	...
	<div class="mod-footer">
		<div class="meta">
			...
			<?php if ($this->user_id) { ?>
				...
				<a class="icb-article-comment text-color-999" data-id="<?php echo $this->comment_info['user_info']['uid']; ?>"><i class="icon icon-comment"></i> <?php _e('回复'); ?></a>
