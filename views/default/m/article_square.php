...
<div class="container">
	...
	<div class="icb-question-list">
		...
		<div class="mod-footer">
			<a id="load_article" class="icb-load-more"><i class="icon icon-loading icon-spin"></i> <span><?php _e('更多'); ?></span></a>
		</div>
	</div>
	<!-- end 动态列表 -->
...
<script type="text/javascript">
	$(document).ready(function () {
		AWS.load_list_view(G_BASE_URL + '/index/ajax/list/post_type-article__sort_type-new__feature_id-<?php echo $_GET['feature_id']; ?>__category_id-<?php echo $_GET['category']; ?>', $('#load_article'), $('#article_listview'), 1);
	});
</script>
