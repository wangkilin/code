	...
	<div class="mod-body">
		<div class="icb-mod mod-base">
			...
			<dl class="form-horizontal">
				...
				<div class="side-bar">
					<dl>
						<dt class="pull-left"><img class="icb-border-radius-5" src="<?php echo get_avatar_url($this->user_id, 'max'); ?>?rand=<?php echo rand(1, 999); ?>" alt="" id="avatar_src" /></dt>
						<dd class="pull-left">
							<h5><?php _e('头像设置'); ?></h5>
							<p><?php _e('支持 jpg、gif、png 等格式的图片'); ?></p>
							<a class="btn btn-mini btn-success" id="avatar_uploader" href="javascript:;"><?php _e('上传头像'); ?></a> <span id="avatar_uploading_status" class="collapse"><i class="icb-loading"></i> <?php _e('文件上传中...'); ?></span>
						</dd>
					</dl>
				</div>
				<!-- end 上传头像 -->
		...
		<!-- 教育经历 -->
		<div class="icb-mod icb-user-educate">
			<div class="mod-head">
				<h3><?php _e('教育经历'); ?></h3>
			</div>
			<div class="mod-body">
		...
		<!-- 工作经历 -->
		<div class="icb-mod icb-user-work">
			<div class="mod-head">
				<h3><?php _e('工作经历'); ?></h3>
			</div>
			<div class="mod-body">
...
$(document).ready(function () {
    ...
    var fileUpload = new FileUploader($('#avatar_uploader'), $('#avatar_src,#user_avatar'), G_BASE_URL + '/account/ajax/avatar_upload/', {'uploadingModalSelector' : '#avatar_uploading_status', 'showUploadImage': true, fileName:'upload_file'});
});
