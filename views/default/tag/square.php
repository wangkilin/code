            ...
            <div class="icb-content-wrap clearfix">
                <div class="col-sm-12 col-md-9 icb-main-content">
                    ...
                    <ul class="nav nav-tabs icb-nav-tabs right hidden-xs">
                        ...
                        <li <?php if ($_GET['day'] == 'month') { ?>class="active"<?php } ?>><a href="topic/channel-hot__day-month"><?php _e('%s 天', 30); ?></a></li>
                        <li <?php if ($_GET['day'] == 'week') { ?>class="active"<?php } ?>><a href="topic/channel-hot__day-week"><?php _e('%s 天', 7); ?></a></li>
                        <li <?php if (!$_GET['day']) { ?>class="active"<?php } ?>><a href="topic/"><?php _e('全部'); ?></a></li>
                        <?php } ?>
