		...
		<div class="row">
			<div class="icb-content-wrap clearfix">
				<div class="col-sm-12 col-md-9 icb-main-content">
					<div class="icb-mod icb-topic-detail-title">
						<div class="mod-body">
							...
							<div class="icb-topic-operate text-color-999">
								<?php if ($this->user_id) { ?>
								<a href="javascript:;" onclick="AWS.User.follow($(this), 'topic', <?php echo $this->topic_info['topic_id']; ?>);" class="follow btn btn-normal btn-success<?php if ($this->topic_info['isFollowed']) { ?> active<?php } ?>"><span><?php if ($this->topic_info['isFollowed']) { ?><?php _e('取消关注'); ?><?php } else { ?><?php _e('关注'); ?><?php } ?></span> <em>|</em> <b><?php echo $this->topic_info['focus_count']; ?></b></a>
								<?php } ?>
							</div>
						</div>
					</div>
				...
				<div class="col-sm-12 col-md-3 icb-side-bar hidden-xs">
					...
					<?php View::output('tag/related_topics.php'); ?>
