                        ...
                        <tbody>
                            ...
                            ?>">
                                ...
                                <td class="text-left px10">
                                    ...
                                    <a class="md-tip"  title="<?php _e('来稿:'); echo str_replace('-','.',$itemInfo['delivery_date']);?> <?php if ($itemInfo['return_date']) { _e('回稿:'); echo str_replace('-','.',$itemInfo['return_date']);}?>" data-toggle="tooltip"><?php echo str_replace('-','.',$itemInfo['delivery_date']);if($itemInfo['return_date']) echo '<br/>'.str_replace('-','.',$itemInfo['return_date']); ?></a>
                                </td>
                                ...
                                <td class="js-serial"><a href="admin/<?php echo CONTROLLER; ?>/index/action-search__serial-<?php echo urlencode($itemInfo['serial']); ?>"><?php echo $itemInfo['serial']; ?></a></td>
                                <td class="js-bookname"><a href="admin/<?php echo CONTROLLER; ?>/index/action-search__serial-<?php echo empty($_GET['serial']) ? '' : urlencode($_GET['serial']); ?>__book_name-<?php echo urlencode($itemInfo['book_name']); ?>"><?php echo $itemInfo['book_name']; ?></a></td>
