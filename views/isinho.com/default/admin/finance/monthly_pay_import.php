                ...
                <div class="table-responsive">
						...
						<div class="icb-mod">
                            ...
                            <div class="row hide hidden  js-import-result">
                                <div  class="col-sm-12">
                                    <form action="admin/ajax/finance/monthly_pay_do_import/" method="post" id="item_form" onsubmit="return false;">
                                        ...
                                        <div class="row hide hidden">
                                            ...
                                            <div class="col-sm-6 col-xs-6">
                                                <select id="excel_sheets" name="excel_sheets"></select>
                                            </div>
                                        </div>
                                        <br/>
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6 col-xs-6">
                                                <span id="js-filename" class=""></span>
                                            </div>
                                        </div>
                                        <br/>
                                        <div class="row">
    ...
    new FileUploader(
            ...
            function (result) {
                ...
                for(var i=0; i<result.sheet_names.length; i++) {
                    $('#excel_sheets').append($('<option></option>').val(result.sheet_names[i]).text(result.sheet_names[i]));
                }

                // 如果 select 标签有 multiple属性，就会生成多选。
                $('#excel_sheets').multiselect({
                    nonSelectedText : '<?php _e('---- 选择工作表 ----');?>',
                    maxHeight       : 200,
                    buttonWidth     : 400,
                    allSelectedText : '<?php _e('已选择全部工作表');?>',
                    numberDisplayed : 4, // 选择框最多提示选择多少个选项
                });
                $('#js-filename').text(result.origin_name);
