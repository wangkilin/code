...
class activeModel extends Model
{
    ...
    public function send_valid_email_crond()
    {
        ...
        $lock_time = Application::cache()->get('send_valid_email_locker');
        ...
        Application::cache()->set('send_valid_email_locker', $now, 300);
        ...
        Application::cache()->delete('send_valid_email_locker');
