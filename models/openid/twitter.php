...
class openid_twitterModel extends Model
{
    ...
    public function oauth_redirect()
    {
        if (!$this->get_request_token() OR !$this->user_authentication())
        {
            if (!$this->error_msg)
            {
                $this->error_msg = Application::lang()->_t('Twitter 登录失败');
            }
    ...
    public function get_request_token()
    {
        ...
        if (!$result)
        {
            $this->error_msg = Application::lang()->_t('获取 request token 时，与 Twitter 通信失败');
        ...
        {
            $this->error_msg = Application::lang()->_t('获取 request token 失败');
        ...
        {
            $this->error_msg = Application::lang()->_t('callback url 设置错误');
    ...
    public function get_access_token()
    {
        ...
        if (!$result)
        {
            $this->error_msg = Application::lang()->_t('获取 access token 时，与 Twitter 通信失败');
        ...
        {
            $this->error_msg = Application::lang()->_t('获取 access token 失败');
    ...
    public function verify_credentials()
    {
        ...
        if (!$result)
        {
            $this->error_msg = Application::lang()->_t('获取个人资料时，与 Twitter 通信失败');
        ...
        if ($result['errors'])
        {
            $this->error_msg = Application::lang()->_t('获取个人资料失败，错误为：%s', $result['errors']['message']);
