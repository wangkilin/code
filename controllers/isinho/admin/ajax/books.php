    ...
    public function do_import_action ()
    {
        ...
        foreach($data['sheetDatas'] as $_index=>$dataList) {
            ...
            foreach ($dataList as $_rowNumber=>$dataLine) {
                ...
                $dataLine[$return_date_key] = is_numeric($dataLine[$return_date_key]) ? date('Y.m.d',($dataLine[$return_date_key]-1) * 24*60*60 +strtotime('18991231')) : $dataLine[$return_date_key];
