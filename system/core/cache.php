...
class core_cache
{
	...
	public function __construct()
	{
		...
		Application::debug_log('cache', null, 'Backend: ' . $this->backendName);
	...
	public function set($key, $value, $lifetime = 60, $group = null)
	{
		...
		if (Application::config()->get('system')->debug)
		{
			...
			Application::debug_log('cache', $stime, 'Save Cache: ' . $key . ', result type: ' . gettype($value));
		}
	...
	public function get($key)
	{
		...
		if (Application::config()->get('system')->debug)
		{
			...
			Application::debug_log('cache', $stime, 'Get Cache: ' . str_replace($this->groupPrefix, '', $key) . ', result type: ' . gettype($result));
		}
